...
export const GITHUB_URL =
  import.meta.env.VITE_GITHUB_URL ?? 'https://github.com/thomascamminady/fitfiller';
...
function Logo() {
  return (
    <svg width="34" height="20" viewBox="0 0 34 20" aria-hidden="true">
      <path d="M2 14 H13" stroke="#1b1b1b" strokeWidth="2.4" strokeLinecap="round" />
      <path
        d="M13 14 H21"
        stroke="#94a3b8"
        strokeWidth="2.4"
      ...
      />
      <path d="M21 14 H32" stroke="#1b1b1b" strokeWidth="2.4" strokeLinecap="round" />
...
export function TopBar({ auth, onReset, onUpgrade, hasActivity }: Props) {
  ...
  return (
    <header className="topbar">
      <button className="wordmark" onClick={onReset} aria-label="fitfiller home">
        <Logo />
        fitfiller
      </button>
